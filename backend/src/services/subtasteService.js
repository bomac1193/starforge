...
const PANTHEON = {
  'S-0': {
    ...
    collaboratesWith: ['T-1', 'F-9'],
    tensionWith: ['R-10', 'V-2'],
    avoidWith: ['H-6'],
    growthToward: 'D-8',
  },
  'T-1': {
  ...
  'L-3': {
    ...
    collaboratesWith: ['P-7', 'V-2'],
    tensionWith: ['R-10', 'F-9'],
    avoidWith: ['H-6'],
    growthToward: 'C-4',
  },
  'C-4': {
  ...
  'P-7': {
    ...
    collaboratesWith: ['L-3', 'N-5'],
    tensionWith: ['H-6', 'R-10'],
    avoidWith: ['F-9'],
    growthToward: 'D-8',
  },
  'D-8': {
